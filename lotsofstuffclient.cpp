...
main(int argc, char *argv[]) {
     ...
     //
     setUpDebugLogging("lotsofstuffclientdebug.txt",argc, argv);
     ...
     try {
       ...
       rpcproxyinitialize(argv[serverArg]);
        ...
        a2[1][1] = 1;
        a3[1][1] = 1;
        cout << "calling showsArraysofArrays(a1, a2, a3)" << endl;
        cout << "return: " << showsArraysofArrays(a1, a2, a3) << endl;
